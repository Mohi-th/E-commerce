    ...
    return (
        <Card className="w-full max-w-sm mx-auto" >
            <div onClick={() => { handleGetProductDetails(product?._id) }}>
                ...
                <CardContent className="p-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                        ...
                        {/* {
                            product.salePrice > 0 ?
                                <span className="text-lg font-semibold text-primary">{product?.brand}</span> :
                                null
                        } */}
            ...
            <CardFooter>
                {
                    product?.totalStock===0?
                    <Button onClick={() => { handleAddToCart(product._id) }} disabled={true} className="w-full cursor-not-allowed opacity-60">Out of Stock</Button>:
